...
def _video_storyboard_text_system_prompt(revision: bool) -> str:
    task = (
        ...
        "Return the complete revised script, not a diff. Preserve useful timing, image "
        "references, product intent, and approved copy unless feedback asks to change them. "
...
def _creative_strategy_system_instruction() -> str:
    return (
        ...
        "with a gameplay-led mini-game challenge and finish on a low-text metallic GAJA game "
        "hub end card. For gaja_brand, use a dark premium neon game lobby with glossy "
        "cards, metallic GAJA logo or wordmark branding, no visible numeric suffix, and "
        "no visible brand-number text. Finish on a Start or Play Now CTA. Keep all "
